<?php
    ...
    class Perhitungan_model extends CI_Model {
		...
		public function getALT(){
			$query=$this->db->query("SELECT id_alternatif, nama FROM alternatif ORDER BY id_alternatif");
			return $query->result();
		}
		...
		public function getdata()
		{
			...
			foreach($rows as $row){$data[$row->id_alternatif][$row->id_kriteria] = $row->nilai; }
			return $data;
		}
    }
